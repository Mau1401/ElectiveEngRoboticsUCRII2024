...
dataRefCirc = readmatrix("Trayectorias/Circle.csv");
...
dataDef = readmatrix('odom_results_parte2_default_circ.csv'); % Datos de la primera simulación
dataMod = readmatrix('odom_results_parte2_mod_circ.csv'); % Datos de la segunda simulación
...
plot(xDef, yDef, 'b-', 'DisplayName', 'Simulación Default', 'LineWidth', 1);
hold on;
